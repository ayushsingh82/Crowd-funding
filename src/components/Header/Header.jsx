...
function Header() {
 ...
 bg-gradient-to-l
    ...
    <span className='shadow-lg shadow-purple-400 '>ScrollScan</span></h1>
  ...
  <div className='mt-[100px] hover:scale-110 transition-all duration-500 ease-in-out'>
    ...
    <br/>
    <br/>
    <span className='text-5xl font-medium bg-gradient-to-l from-gray-900 via-purple-900 to-violet-600 text-transparent bg-clip-text shadow-sm'>Scroll Domain</span>  </h1>
    <br/>
    <br/>
    <p className='text-2xl text-slate-800'>Enter name.scroll to get details</p>
  </div>
  </>
  )
}
